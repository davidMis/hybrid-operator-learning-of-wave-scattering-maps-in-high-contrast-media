# Overview:
# Compare generated Helmholtz pressure fields against the published complex
# pressure arrays. The primary metric aligns each generated field by the best
# complex scalar first, separating geometry or discretization errors from source
